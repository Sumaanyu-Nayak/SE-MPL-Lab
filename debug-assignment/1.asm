...
section .data
    msg1 db "Write an x86/64 ALP to find the largest of given 5 64-bit hexadecimal numbers from user.",10, "Name:- Sumaanyu",10,"Roll:- 7256",10,"Date of Performance:- 28/02/2025",10
    msg1len equ $-msg1
